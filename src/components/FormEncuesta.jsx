    ...
    return (
        <form className="card card-body">
            <div className="form-group input-group"></div>
                <label className="form-label mt-4">Nombre Completo</label>
                ...
                <select className="form-control form-select" id="country_of_origin">
                ...
                <div className="form-control form-check mt-4">
                    <input className="form-label mt-4" type="checkbox" value="" 
